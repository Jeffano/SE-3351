...
def recommend_items(top_categories, retail_data, top_n=10):
    recommended_items = []
    for category in top_categories:
        # Extract items under each category and add to the recommendation list
...
def run_recommendation_system(grocery_file, retail_file, test_user):
    ...
    recommendations = recommend_items(top_categories, retail_data)
